    ...
    children: _jsxs("div", {
      ...
      children: [
        _jsxs(motion.div, {
          ...
          className:
            "inline-flex items-center space-x-2 bg-yellow-200/50 dark:bg-yellow-900/30 px-4 py-2 rounded-full mb-6",
          children: [
            _jsx(TrendingUp, {
            ...
            _jsx("span", {
              className:
                "text-sm font-medium text-yellow-800 dark:text-yellow-300",
              children: "Live Market Rates",
            }),
          ],
        }),
        _jsxs("h1", {
          className:
            "text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-yellow-600 to-yellow-800 bg-clip-text text-transparent",
          children: ["Today's Gold Price (", currentRate?.currency, ")"],
        }),
        _jsx("p", {
          ...
          children: [
            ...
            _jsx(
              motion.div,
              {
                ...
                className:
                  "bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow",
                children: _jsxs("div", {
                  className: "text-center",
                  children: [
                    _jsx("div", {
                      className:
                        "inline-flex items-center justify-center w-16 h-16 rounded-full bg-yellow-100 dark:bg-yellow-900/30 mb-4",
                      children: _jsx("span", {
            ...
            children: [
              ...
              _jsxs("span", {
                children: [
                  ...
                  " ",
                  format(
                    new Date(currentRate?.created_at),
                    "MMM dd, yyyy HH:mm"
                  ),
                ],
              }),
